...
$modelDir = Join-Path $LocalRoot 'models\gittensor\Qwen3.8-27B-NVFP4-RTX5090'
$draftDir = Join-Path $LocalRoot 'models\RadixArk\Qwen3.8-27B-DSpark'
...
Invoke-HfDownload -Repo $draftRepo -Revision $draftRevision -LocalDir $draftDir
